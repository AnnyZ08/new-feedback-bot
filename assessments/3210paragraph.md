...
Use second person (“you need to…”, “this doesn’t make sense”).

Focus on argument, clarity, and evidence, not on re-explaining the assignment.

Only bring up structure (topic sentence, quotes, conclusion) if the student clearly failed at it.
...
Three direct quotes with page numbers.
...
“I don’t see your argument here, just description.”

“You need a direct quote with page number.”

“This example doesn’t connect back to your point.”

“Right now this is summary, not analysis.”

“Clarify what you mean by X—too vague.”

“Tie this evidence back to your main claim.”

“This sentence doesn’t make sense—rewrite.”
...
Topic sentence in your own words — no citations, no author names. It should set up your argument clearly.

Three direct quotes from different course readings — each with author, year, and page number in brackets.

Example: (Edgerton 2006, 45).

Explanation of each quote in your own words — at least one full sentence after every quote.

Explain why the quote matters and how it supports your argument.

Concluding sentence — tie the evidence back to your argument and show why it’s significant.
...
Only paraphrasing readings instead of using direct quotes.

Dropping in quotes without page numbers.

Summarizing authors instead of making your own argument.
...
Three sources = range, not repetition.

Your own words after each quote = your voice, not just summary.

Clear structure = readable, arguable paragraph.
